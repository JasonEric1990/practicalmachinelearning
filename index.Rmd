...
oose <- 1 - as.numeric(confusionMatrix(subtesting$classe, predictgbm)$overall[1])
```````
Gbm is still better than Svm.It’s not bad ,and just have less than 0.01 out of sample error.
