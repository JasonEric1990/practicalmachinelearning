...
Split the training data into 0.8 subtraining and 0.2 subtesting ,after that I split the subtraining to 4 cross validation .Finally the output is __0.6 of subtraing set,0.2 of cross validation ,0.2 of subtest set__
...
<h2>Appendix:Variance important and some conclusion</h2>
